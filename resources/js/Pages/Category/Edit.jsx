...
function Edit ({category, parents = [],onSuccessHandler,onErrorHandler,menu,onClose,loadCategories,loadMenu }) {
...
const { data, setData, post, processing, errors, reset } = useForm ({
  ...
  */
   ...
   const { data, setData, put, processing, errors,reset } = useForm({
        ...
        parent: category.parent?.id ? {value:category.parent.id,label:category.parent.title} : null,
        parent_id: category.parent_id || '',
        menu_id: category.menu_id || '',
        menu:category.menu?.id ? {value:category.menu.id,label:category.menu.title} : null,
