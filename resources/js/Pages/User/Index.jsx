                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-gray-200">
                        ...
                        {usersList?.data.map((item) => (
                            ...
                            <tr key={item.id} className={`hover:bg-blue-50 transition ${item.status ? '':'bg-red-200'}`}>
                                ...
                                <td className="px-6 py-4 text-right">
                                    <ul className="flex items-center gap-2 list-none">
                                            ...
                                            <li>
                                                <button 
                                                    title="Удалить"
                                                    className="p-2 rounded border border-red-200 text-red-600 hover:bg-red-100 transition"
                                            ...
                                            <li>
                                                <button 
                                                title="Изменить"
                                                className="p-2 text-blue-600 hover:bg-blue-50 rounded transition-colors border border-blue-200"
                                                onClick={()=>{
                                            ...
                                            <li>
                                                ...
                                                className="p-2 text-yellow-600 hover:bg-yellow-50 rounded transition-colors border border-yellow-200"
                                                onClick={()=>{
                                                        setSelectedUser(item); 
                                            ...
                                            <li>
                                                <button 
                                                title="Изменить роль"
                                                className="p-2 text-purple-600 hover:bg-purple-50 rounded transition-colors border border-purple-200"
                                                onClick={()=>{
                                                        setSelectedUser(item); 
                                                        setRoleModal(true);
                                                    }
                                            ...
                                            <button 
                                                title="Блокировать"
                                                className="p-2 text-amber-600 hover:bg-amber-50 rounded transition-colors border border-amber-200"
                                                onClick={() => {
